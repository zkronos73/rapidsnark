...
#pragma pack(pop)
    ...
    public:
        ...
        protected:
            ...
            void loadFrElements ( FrElements &destination, const FrElement *source, int64_t offset, int64_t count, int64_t seek = 0 ); 
            ...
            u_int64_t toRprBE(G1P &point, uint8_t *data, int64_t seek, int64_t size);
